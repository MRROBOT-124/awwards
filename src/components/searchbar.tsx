...
const Searchbar: React.FC<SearchbarProps> = ({}) => {
    ...
    const [dropdown, setDropdownToggle] = useState(false);
        return (
            <form className={`search flex items-center basis-9/12 pl-5 ${toggle ? 'dark': ''}`} 
            ...
            >
                ...
                {/* INPUT */}
                <input className='basis-9/12 pl-3 h-[48px] text-sm font-normal self-stretch' type="text" name="search" id="search"  placeholder='Search websites, elements, courses...'/>
